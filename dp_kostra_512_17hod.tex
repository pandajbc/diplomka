...
\documentclass[12pt, twoside,openany]{book} % vel. pisma, oboustr. tisk a typ dokumentu
...
\addto\captionsczech{\renewcommand{\appendixname}{Appendix}}
...
\section{Gradient boosted decision tree}    %definice a popis metody
 \label{1.2}
...
\newpage
\section{Theoretical models}    %vysloveni teor. modelu
...
\includegraphics[width=\textwidth]{importance_ml1.pdf}
\captionof{figure}{Importance figure of all independent variables used in ML model 1 [source: own construction]}
...
\captionof{figure}{Example of a full decision tree from ML model 1 [source: own construction]}
...
\captionof{figure}{Cutout from a decision tree from ML model 1 [source: own construction]}
